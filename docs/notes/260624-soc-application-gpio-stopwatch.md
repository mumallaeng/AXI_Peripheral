...
260630 AXI project 발표 요구사항은 [26-06-24 - AXI Project 발표 요구사항](../assignment/_project/260630-axi/10-presentation-requirements-260624.md)에 따로 정리했다. 발표 쪽 문서는 AXI peripheral을 메인으로 두고, system architecture, Xilinx AXI template와 custom IP 연동, register map, firmware, UVM 검증 범위, UART/SPI/I2C demo 방향을 구체적으로 다룬다.
