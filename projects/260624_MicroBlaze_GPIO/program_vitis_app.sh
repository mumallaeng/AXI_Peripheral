...
bit="$script_dir/260624_MicroBlaze_GPIO.runs/impl_1/stopwatch_design_wrapper.bit"
mmi="$script_dir/260624_MicroBlaze_GPIO.runs/impl_1/stopwatch_design_wrapper.mmi"
out_bit="$script_dir/260624_MicroBlaze_GPIO.runs/impl_1/stopwatch_design_wrapper_with_elf.bit"
