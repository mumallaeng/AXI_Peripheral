...
set project_file [file join $script_dir "260624_MicroBlaze_GPIO.xpr"]
...
if {[get_property PROGRESS [get_runs synth_1]] ne "100%"} {
    error "synth_1 did not complete. Check 260624_MicroBlaze_GPIO.runs/synth_1/stopwatch_design_wrapper.vds"
}
...
if {[get_property PROGRESS [get_runs impl_1]] ne "100%"} {
    error "impl_1 did not complete. Check 260624_MicroBlaze_GPIO.runs/impl_1/runme.log"
}

set bit_files [glob -nocomplain [file join $script_dir "260624_MicroBlaze_GPIO.runs" "impl_1" "*.bit"]]
if {[llength $bit_files] == 0} {
    error "BIT file was not created under 260624_MicroBlaze_GPIO.runs/impl_1"
}
