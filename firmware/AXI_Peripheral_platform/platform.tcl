# Re-create the Vitis platform project from the XSA exported by Vivado.
#
# Expected XSA:
#   firmware/AXI_Peripheral_platform/hw/AXI_Peripheral.xsa

set script_dir [file dirname [file normalize [info script]]]
set workspace_dir [file dirname $script_dir]
set xsa_path [file join $script_dir hw AXI_Peripheral.xsa]
