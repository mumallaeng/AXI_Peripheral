proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins controller_0/M_AXI ] [get_bd_intf_pins uart_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins controller_0/ACLK] [get_bd_pins uart_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins controller_0/ARESETN] [get_bd_pins uart_0/S00_AXI_ARESETN]
